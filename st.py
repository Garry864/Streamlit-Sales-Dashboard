...
# groq_api_key = "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"
...
show_data = st.sidebar.toggle("Use raw data", value=False, help = "Toggle to choose wether to work with filtered Data or Raw Data")
if show_data:
    filtered_df = df.copy()
...
# Streamlit Interface
st.header(":point_right: Explore insights from this Data using LLM")
...
if chat_input := st.chat_input("Ask a question about the data"):
    try:
        ...
        # Display answer in the history from the assitant
