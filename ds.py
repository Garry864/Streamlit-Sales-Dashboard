...
if not region and not state and not city:
    ...
    filtered_df = df[df["State"].isin(region)]
elif state and city:
...
# Catergory Chart
category_df = filtered_df.groupby(by = ["Category"], as_index=False)["Sales"].sum() # note without index also possible
